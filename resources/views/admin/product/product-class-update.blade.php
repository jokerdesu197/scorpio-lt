        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form class="form-horizontal form-label-left" method="post" action="{{ route('post-product-class-create' , $product_class->id)}}">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <select name="product_id" class="form-control">
                                    	...
                                    	<option value="{{ $product->id}}" {{ $product->id == $product_class->product_id ? 'selected' : null }}>{{ $product->name}}</option>
                                    	@endforeach
                                    </select>
                                </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <select name="product_type_id" class="form-control">
                                    	...
                                    	<option value="{{ $type->id}}" {{ $type->id == $product_class->product_type_id ? 'selected' : null }}>{{ $type->name}}</option>
                                    	@endforeach
                                    </select>
                                </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input class="form-control" type="text" name="stock" value="{{ $product_class->stock }}">
                                </div>
                                @if($errors->has('stock'))
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input class="form-control" type="text" name="sale_limit" value="{{ $product_class->sale_limit}}">
                                </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input class="form-control" type="text" name="price01" value="{{ $product_class->price01 }}">
                                </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input class="form-control" type="text" name="price02" value="{{ $product_class->price02 }}">
                                </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input class="form-control" type="date" name="delivery_date" value="{{ date('Y-m-d', strtotime($product_class->delivery_date))}}">
                                </div>
