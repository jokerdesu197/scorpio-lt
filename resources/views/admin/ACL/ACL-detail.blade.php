    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <form class="form-horizontal" method="post" action="{{route('post-ACL-create', $role->id)}}">
                        {{csrf_field()}}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 pb-2">
                                <textarea rows="6" cols="50" class="form-control" name="description">{{ $role->description}}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                                    ...
                                    <table class="table table-bordered">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="table-active"></td>
                                                <td class="table-light">
                                                    <input id="permission-2" data="2" type="checkbox" class="i-checks check-permission-1" name="permission_id[]"  value="{{$perm->id}}" @if (in_array($perm->id, $perm_id))checked @else '' @endif>
                                            ...
                                            <tr>
                                                <td class="table-active"></td>
                                                <td class="table-light">
                                                    <input id="permission-4" data="2" type="checkbox" class="i-checks check-permission-2" name="permission_id[]"  value="{{$perm->id}}" @if (in_array($perm->id, $perm_id))checked @else '' @endif>
                                                    <span class="m-l-xs">{{$perm->description}}</span>
                                                </td>
                                            </tr>
                                            @endforeach
                                            ...
                                            <tr>
                                                <td class="table-active"></td>
                                                <td class="table-light">
                                                    <input id="permission-6" data="2" type="checkbox" class="i-checks check-permission-3" name="permission_id[]"  value="{{$perm->id}}" @if (in_array($perm->id, $perm_id))checked @else '' @endif>
                                                    <span class="m-l-xs">{{$perm->description}}</span>
                                                </td>
                                            </tr>
                                            @endforeach
                                            ...
                                            <tr>
                                                <td class="table-active"></td>
                                                <td class="table-light">
                                                    <input id="permission-8" data="2" type="checkbox" class="i-checks check-permission-4" name="permission_id[]"  value="{{$perm->id}}" @if (in_array($perm->id, $perm_id))checked @else '' @endif>
                                                    <span class="m-l-xs">{{$perm->description}}</span>
                                                </td>
                                            </tr>
                                            @endforeach
